...
k = 3                                                   # k is size of continuous numbers chosen from the series
...
while num> 0:  # // 10 ** (k - 1)                       # using while loop here 
    ...
    while digits > 0:                                   #using nested while loop here till digit drops to 0
        ...
        if product == 0:
            break
        digits = digits // 10                                   #flooring the value of num one digit at a time 
    ...
    num = num // 10                                          #flooring the value of num, eliminating/deleting digits one at a time>> LOOP to 7
